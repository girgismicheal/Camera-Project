...
FILE * pFileTXT_lidar, *pFileTXT_camera;
...
int main(int argc, const char *argv[])
{
    /* INIT VARIABLES AND DATA STRUCTURES */
  	fclose(fopen("../TTC_Lidar.txt", "w"));
  	fclose(fopen("../TTC_Camera.txt", "w"));
  	pFileTXT_lidar = fopen("../TTC_Lidar.txt","a");
  	pFileTXT_camera = fopen("../TTC_Camera.txt","a");
  
//   vector<string> detectorTypes{ "SHITOMASI", "HARRIS", "FAST", "BRISK", "ORB", "AKAZE", "SIFT"};	
//   vector<string> descriptorTypes{ "BRISK", "BRIEF", "ORB", "FREAK", "AKAZE", "SIFT"};
  
  vector<string> detectorTypes{"SHITOMASI"};	
  vector<string> descriptorTypes{"FREAK"};
  	
  	for (int i = 0; i < detectorTypes.size(); i++){
      for (int j = 0; j < descriptorTypes.size(); j++){
     
    string detectorType = detectorTypes[i];
  	string descriptorType = descriptorTypes[j];
...
//   	string descriptorType = "BRISK";
    ...
    fprintf (pFileTXT_lidar, "%s/%s : ", detectorType.c_str(), descriptorType.c_str());
    fprintf (pFileTXT_camera, "%s/%s : ", detectorType.c_str(), descriptorType.c_str());
...
//         string descriptorType = "BRISK"; // BRISK, BRIEF, ORB, FREAK, AKAZE, SIFT
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            string matcherType = "MAT_BF";        // MAT_BF, MAT_FLANN
          	...
          	if(descriptorType=="SIFT"){descriptorTypeClass = "DES_HOG";}
...
//                       	pFileTXT_lidar = fopen("../TTC_Lidar.txt","a");
                      	fprintf (pFileTXT_lidar, "%f, ", ttcLidar);
                      	
//                       	pFileTXT_camera = fopen("../TTC_Camera.txt","a");
                      	fprintf (pFileTXT_camera, "%f, ", ttcCamera);
	...
	fprintf (pFileTXT_lidar, "\n");
    fprintf (pFileTXT_camera, "\n");
    }
    }
    return 0;
}
